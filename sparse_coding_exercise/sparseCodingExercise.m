...
numFeatures = 196;    % number of features to learn
...
for iteration = 1:100                      
    ...
    featureMatrix = reshape(featureMatrix, numFeatures, batchNumPatches);                                      
	 ...
	 [cost, grad] = sparseCodingFeatureCost(weightMatrix, featureMatrix, visibleSize, numFeatures, batchPatches, gamma, lambda, epsilon, groupMatrix);
     disp(norm(grad));
